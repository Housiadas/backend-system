...
import (
	...
	"github.com/Housiadas/backend-system/foundation/metrics/collector"
	"github.com/Housiadas/backend-system/foundation/metrics/publisher"
	prometheussrv "github.com/Housiadas/backend-system/foundation/metrics/publisher/prometheus"
...
func run(ctx context.Context, log *logger.Logger) error {
	...
	traceProvider, err := otel.StartTracing(
		cfg.Otel.Host,
	...
	prom := prometheussrv.New(
		log, cfg.Prometheus.Host, cfg.Prometheus.Route, cfg.Prometheus.ReadTimeout, cfg.Prometheus.WriteTimeout, cfg.Prometheus.IdleTimeout,
	)
	...
	publish, err := publisher.New(log, collector, cfg.Publish.Interval, prom.Publish, stdout.Publish)
	if err != nil {
