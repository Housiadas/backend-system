...
// package because we normally don't want to deal with pointers to basic service,
...
// because we normally don't want to deal with pointers to basic service, but it's
