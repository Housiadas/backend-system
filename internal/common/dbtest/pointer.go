...
// package because we normally don't want to deal with pointers to basic domain,
...
// because we normally don't want to deal with pointers to basic domain, but it's
